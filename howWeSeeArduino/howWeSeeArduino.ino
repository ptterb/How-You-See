...
const int areaColors[7][3]={                 // colors for each vision area.
  {200, 0, 0},                               // vision function 1 color value
  {0, 200, 0},                               // vision function 2 color value
  {0, 0, 200},                               // vision function 3 color value
  {255, 255, 0},                             // vision function 4 color value
  {255, 0, 150},                             // vision function 5 color value
  {0, 255, 0},                               // vision function 6 color value
  {0, 0, 0}};                                // all off
